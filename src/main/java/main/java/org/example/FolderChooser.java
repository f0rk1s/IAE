...
public class FolderChooser extends JPanel {
    ...
    public JPanel createFolderChooserPanel(org.example.Main mainFrame) {
        ...
        JButton openButton = new JButton("Open a Folder...");
        ...
        JButton saveButton = new JButton("Save a Folder...");
